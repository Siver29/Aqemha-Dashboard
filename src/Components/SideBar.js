...
function SideBar() {
  ...
  return (
    <div className="sidebar position-fixed sticky-top">
    ...
    <p className=''>Salma</p>
      {/* <div className='w-50 mx-auto'>
        <img className='img-fluid rounded-circle' src="https://images.unsplash.com/photo-1527736947477-2790e28f3443?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTE2fHx3b21hbnxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=60" alt="Account"/>
        <p className='mt-3'>Annie</p>
      </div> */}
    </div>
    <ul className="sidebar-list mt-5">
      <li className={`sidebar-list-item ${location.pathname === '/volunteers' ? 'active' : ''}`}>
        <Link to="/volunteers">
      ...
      <li className={`sidebar-list-item ${location.pathname === '/beneficiaries' ? 'active' : ''}`}>
      ...
      <li className={`sidebar-list-item ${location.pathname === '/donations' ? 'active' : ''}`}>
        <Link to="donations">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>
          <span>التبرعات</span>
        </Link>
      ...
      <li className={`sidebar-list-item ${location.pathname === '/' ? 'active' : ''}`}>
        <Link to="/">
          ...
          <span>إدارة حملة تطوعية</span>
        </Link>
      </li>
      <li className={`sidebar-list-item ${location.pathname === '/programs' ? 'active' : ''}`}>
        <Link to="programs">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>
          <span>البرامج</span>
        </Link>
      </li>
      <li className={`sidebar-list-item ${location.pathname === '/refer' ? 'active' : ''}`}>
        <Link to="refer">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>
